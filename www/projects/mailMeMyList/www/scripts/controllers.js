myApp.controller('AccountController', ['$scope', 'Authentication', 'sharedTasks', '$firebaseAuth', 'FIREBASE_URL', '$ionicPopup', '$timeout',
  function($scope, Authentication, sharedTasks, $firebaseAuth, FIREBASE_URL, $ionicPopup, $timeout) {
  $scope.firstname;
  $scope.lastname;
  ...
  //   // $scope.showLoginContent = sharedTasks.getShowLoginContent();
  // }
  ...
  $scope.saveAccountChanges = function(newFirstname, newLastname, newEmail) {
    sharedTasks.updateAccountFirstname(newFirstname);
    sharedTasks.updateAccountLastname(newLastname);
    sharedTasks.updateAccountEmail(newEmail);
  };
